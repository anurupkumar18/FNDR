...
| 07:59 | T8a clean card internals | pending commit | typecheck ✅ · MemoryCard focused tests 34 ✅ | removed FRAME ids, empty insight placeholders, and raw synthesis branch chips while preserving lifecycle and grounded insight rows |
| 08:00 | T7 needs-signal queue | pending commit | typecheck ✅ · MemoryCardsPanel 2 tests ✅ | added a Vault-only toggle for stored low-signal captures; it shows only app, timestamp, and plain-language reason, never filename/title |
| 08:27 | T10 shared retrieval and summary quality | pending commit | daily-summary Rust regression ✅ · Ask/command/timeline 8 tests ✅ · typecheck ✅ | Search & Ask uses one local-evidence message; Stats and To-dos restored; Daily Summary excludes low-signal visual fallbacks; quality contract added |
