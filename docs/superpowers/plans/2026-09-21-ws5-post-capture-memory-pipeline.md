...
| P13 Finalization | `memory_quality::classify_storage_outcome`, lifecycle chips (HANDOFF.md) | A record ends as developed, pending, raw, review_failed, or visual_failed | Rules scattered; no single contract | invariant tests pass | One contract as tests | MEM-07 | MEM-07 |
