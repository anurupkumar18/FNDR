...
Status: Draft for review (2026-08-19; revised 2026-08-20: team pain points folded in, plan-review fixes applied per `review/REVIEW-2026-08-20.md`). Produced from the v2 discovery brief, a full code audit of the v1 proof of concept, and fresh technology research. Companion documents: `docs/v2/ARCHITECTURE.md`, `docs/v2/decisions/ADR-001` through `ADR-007`, `docs/v2/ROADMAP-TICKETS.md`.
