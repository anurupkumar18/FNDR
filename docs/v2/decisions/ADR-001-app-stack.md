...
The technology due-diligence review (docs/v2/review/technical-verification.md) confirmed the stack but added the mitigations now in action items 2 and 4: tauri-specta is permanently release-candidate and requires pinning discipline, and the crates.io screencapturekit crate is a single-maintainer bet requiring a soak test and a named fallback.
