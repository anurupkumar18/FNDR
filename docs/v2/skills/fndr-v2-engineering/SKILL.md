...
1. `docs/v2/ARCHITECTURE.md` (crate map, data flow, lane boundaries)
2. `docs/v2/decisions/` ADR-001..007 (the choices; do not re-litigate silently)
3. `docs/v2/PRD.md` (scope, P0s, the month-3 demo gate)
